...
export default function Footer() {
  return (
    <footer className="w-full bg-[#231F20] text-white py-8 px-6 md:px-8">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0 max-w-7xl mx-auto">
        {/* LEFT: Logo Name */}
        <Link
          href="/"
        ...
        {/* RIGHT: Social Icons */}
        {/* Added flex-wrap and justify-center to handle small screens */}
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          >
            <svg
              viewBox="0 0 16 16"
              fill="currentColor"
              className="w-8 h-8 md:w-9 md:h-9" // Slightly smaller on mobile
              aria-hidden="true"
            >
